...
#--------------------------
    ...
    def mapper(self, in_key, in_value):
        ...
        yield None, int(in_value.split(',')[3])
...
#--------------------------
    ...
    def mapper(self, in_key, in_value):
        ...
        name, r, c, value, _, _ = in_value.split(',')
        yield None, (name, int(r), int(c), int(value))
    ...
    def reducer(self, in_key, in_values):
        ...
        for name, r, c, value in in_values:
            if name == 'A':
                matrix_a[c-1] = value
            else:
                matrix_b[r-1] = value

        yield ('C', 1, 1), np.dot(matrix_a, matrix_b)
...
#--------------------------
    ...
    def mapper(self, in_key, in_value):
        ...
        if name == 'A':
            yield ('C', row, 1), ('A', row, col, value)
            yield ('C', row, 2), ('A', row, col, value)
        else:
            yield ('C', 1, col), ('B', row, col, value)
            yield ('C', 2, col), ('B', row, col, value)
...
#--------------------------
    ...
    def reducer(self, in_key, in_values):
        ...
        yield in_key, np.dot(matrix_a, matrix_b)
