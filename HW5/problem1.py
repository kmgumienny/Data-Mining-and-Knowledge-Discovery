...
class TicTacToe(BoardGame):
    ...
    def get_valid_moves(self, s):
        ...
        is_zero = np.where(s.b == 0)
        m = []
        for i in range(len(is_zero[0])):
            m.append((is_zero[0][i], is_zero[1][i]))
    ...
    def check_game(self,s):
        ...
        if s.b[0, 0] != 0 and (s.b[0, 0] == s.b[0, 1] == s.b[0, 2]):
            e = s.b[0, 0]
        elif s.b[1, 0] != 0 and (s.b[1, 0] == s.b[1, 1] == s.b[1, 2]):
            e = s.b[1, 0]
        elif s.b[2, 0] != 0 and (s.b[2, 0] == s.b[2, 1] == s.b[2, 2]):
            e = s.b[2, 0]
        elif s.b[0, 0] != 0 and (s.b[0, 0] == s.b[1, 1] == s.b[2, 2]):
            e = s.b[0, 0]
        elif s.b[0, 2] != 0 and (s.b[0, 2] == s.b[1, 1] == s.b[2, 0]):
            e = s.b[0, 2]
        elif s.b[0, 0] != 0 and (s.b[0, 0] == s.b[1, 0] == s.b[2, 0]):
            e = s.b[0, 0]
        elif s.b[0, 1] != 0 and (s.b[0, 1] == s.b[1, 1] == s.b[2, 1]):
            e = s.b[1, 1]
        elif s.b[0, 2] != 0 and (s.b[0, 2] == s.b[1, 2] == s.b[2, 2]):
            e = s.b[0, 2]
        else:
            e = 0
...
class RandomPlayer(Player):
    ...
    def choose_a_move(self,g,s):
        ...
        rand = np.random.randint(0, len(m))
        r, c = m[rand]
...
class MMNode(Node):
    ...
    def expand(self,g):
       ...
       |-------------------------------
        ...
        m = g.get_move_state_pairs(self.s)
        ...
        for i in range(len(m)):
            ...
            # self.c.append(MMNode(m[i][1], self, [], (m[i][0]), g.check_game(m[i][1])))
            self.c.append(MMNode(m[i][1], self, [], (m[i][0]), None))
