...
def Terms_and_Conditions():
    ''' 
      ...
      homework submissions and we handled ALL of these violations according to the WPI Academic Honesty Policy.
    '''
    #****************************************
    #* CHANGE CODE HERE
...
def compute_eigen_pairs(X):
    ...
    vector, value = np.linalg.eigh(X)

    Ep = [(vector[i], value[:, i]) for i in range(len(vector))]
